...
class CNN(nn.Module):
    def __init__(self, num_class=15):
        ...
        # layer 3
        self.conv_3 = AttentionConv(128, 128, 3, padding=1)
    ...
    def forward(self, x):
        ...
        #x = self.mp_1(activate.AReLU()(self.bn_1(self.conv_1(x))))
        
        # layer 2
        x = self.mp_2(nn.ELU()(self.bn_2(self.conv_2(x))))
        #x = self.mp_2(activate.AReLU()(self.bn_2(self.conv_2(x))))
        
        # layer 3
        x = self.mp_3(nn.ELU()(self.bn_3(self.conv_3(x))))
        #x = self.mp_3(activate.AReLU()(self.bn_3(self.conv_3(x))))

        # layer 4
        x = self.mp_4(nn.ELU()(self.bn_4(self.conv_4(x))))
        #x = self.mp_4(activate.AReLU()(self.bn_4(self.conv_4(x))))

        # layer 5
        x = self.mp_5(nn.ELU()(self.bn_5(self.conv_5(x))))
        #x = self.mp_5(activate.AReLU()(self.bn_5(self.conv_5(x))))
